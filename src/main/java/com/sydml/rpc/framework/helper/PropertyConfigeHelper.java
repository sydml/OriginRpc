package com.sydml.rpc.framework.helper;
...
public class PropertyConfigeHelper {
    ...
    static {
        ...
        try {
            ...
            channelConnectSize = Integer.parseInt(properties.getProperty("baseSleepTimeMs", "1000"));
            channelConnectSize = Integer.parseInt(properties.getProperty("maxRetries", "3"));
